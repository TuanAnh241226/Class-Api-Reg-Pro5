#code by: Nguyễn Tuấn Anh
#Facebook: https://www.facebook.com/nguyentuananhdev.profile/
import requests
import random
class reg_pro5():
    def __init__(self,cookies) -> None:
        ...
        self.name = f'Nguyễn Tuấn Anh {number}'
...
cookies = '' #cookies acc cần reg (chỉ acc đang reg được pro5 mới dùng được)
p = reg_pro5(cookies)
print(p.Reg()) #kết quả trả về của api